...
During most lectures we will do some coding and/or run some example code I provide. Please bring your laptop. We recommend to [create a class specific virtual environment](tutorials/python_setup.qmd)
